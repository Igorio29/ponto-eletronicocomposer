...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Relatórios com IA')); ?>
    ...
    <script>
        async function gerarRelatorio() {
            ...
            try {
                const response = await fetch('<?php echo e(route("relatorios.gerar")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php endif; ?>
<?php /**PATH C:\Users\Igor\Documents\PHP\ponto-eletronicocomposer\resources\views/relatorios/index.blade.php ENDPATH**/ ?>